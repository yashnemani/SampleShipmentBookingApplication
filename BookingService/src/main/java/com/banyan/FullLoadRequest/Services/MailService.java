package com.banyan.FullLoadRequest.Services;
...
public class MailService {
	...
	public MailService(JavaMailSender mailSender, @Value("${error.email.from}") String errorEmailFrom, @Value("${error.email.to}") String errorEmailTo, @Value("${error.email.subject}") String errorEmailSubject) {
	...
	public void sendMail(String from, String to, String subject, String body, String[] attachments, ByteArrayResource byteAttachment, String filename, boolean asHtml) {
		...
		try {
			...
			if (log.isInfoEnabled()) log.info("Sending email to ..." + to);
	...
	public void sendMail(String from, String to, String subject, String body, String[] attachment, ByteArrayResource byteAttachment, String filename) {
	...
	public void sendMail(String subject, String message) {
		sendMail(errorEmailFrom, errorEmailTo, subject, message, (String[]) null, (ByteArrayResource) null, (String) null, false);
	}

	public void sendMail(String message) {
		sendMail(errorEmailFrom, errorEmailTo, errorEmailSubject, message, (String[]) null, (ByteArrayResource) null, (String) null, false);
	}
	...
	public void sendMail(String to, String subject, String message, boolean asHtml) {
		sendMail(errorEmailFrom, to, subject, message, (String[]) null, (ByteArrayResource) null, (String) null, asHtml);
	}

	public void sendMail(String subject, String message, boolean asHtml) {
		sendMail(errorEmailFrom, errorEmailTo, subject, message, (String[]) null, (ByteArrayResource) null, (String) null, asHtml);
	}

	public void sendMail(String message, boolean asHtml) {
		sendMail(errorEmailFrom, errorEmailTo, errorEmailSubject, message, (String[]) null, (ByteArrayResource) null, (String) null, asHtml);
	}
